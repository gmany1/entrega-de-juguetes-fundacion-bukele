...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  whatsappTemplate: "*Hola, soy {name}.*\nConfirmo mi asistencia al evento *“Compartiendo Sonrisas”*.\nHe registrado *{count} invitaciones*:\n• {invites}\n\n👉 *Solicito que me envíen los detalles de lugar y hora por este mismo medio.* al {phone}\n\n📲 Guardaré este número en mis contactos para futuras comunicaciones. {contactName}\n\n🙏 *¡Que Dios me los bendiga!*",
